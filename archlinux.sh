...
pacman-key --init && pacman-key --populate archlinux &&  pacman-key --refresh-keys && pacman -Sy archlinux-keyring --noconfirm
echo -e "\n"
...
wget https://github.com/Jguer/yay/releases/download/v11.2.0/yay_11.2.0_x86_64.tar.gz && pacman -U ./yay_11.2.0_x86_64.tar.gz && yay -S rate-mirrors-bin --noconfirm && rate-mirrors --allow-root --save /etc/pacman.d/mirrorlist arch